            ...
            <div className="glass-card rounded-3xl p-8 sticky top-24 shadow-2xl shadow-black/50 border-t border-white/10">
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <p className="text-4xl font-display font-bold text-white">{formatCurrency(facility.hourlyRate)}<span className="text-lg text-gray-500 font-sans font-normal">/hr</span></p>
                </div>
